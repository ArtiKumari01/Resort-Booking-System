  ...
  <section id="one">
   ...
   <div class="items">
    ...
    <a class="b" href="home.php">Home</a>
     ...
     <a class="b"  href="resturant.php" >Restaurant</a>
   ...
   <h3 class="text1">
    ...
    text-transform: none;
    line-height: 1;
    -webkit-font-smoothing: antialiased;" class="t t1">About</span>
   ...
   <section id="third">
    <div class="cont4">
      <div class="head4">Welcome To Our Hotel</div>
      <div class="head44">
        <div class="head444" style="background-image:url(images/ro1.jpg)">
        <a id="aaa" href="https://vimeo.com/45830194" class="icon popup-vimeo d-flex justify-content-center align-items-center">
<span class="icon-play">start</span>
</a>
        </div>
        <div class="head445">
        <p class="pfour">On her way she met a copy. The copy warned the Little Blind Text, that where it came from it would have been rewritten a thousand times and everything that was left from its origin would be the word "and" and the Little Blind Text should turn around and return to its own, safe country. But nothing the copy said could convince her and so it didn’t take long until a few insidious Copy Writers ambushed her, made her drunk with Longe and Parole and dragged her into their agency, where they abused her for their.</p>
